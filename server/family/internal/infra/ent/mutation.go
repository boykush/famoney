...
func (m *MemberMutation) SetOidcSubject(s string) {
	m.oidc_subject = &s
}

// OidcSubject returns the value of the "oidc_subject" field in the mutation.
func (m *MemberMutation) OidcSubject() (r string, exists bool) {
	v := m.oidc_subject
	if v == nil {
		return
	}
...
// OldOidcSubject returns the old "oidc_subject" field's value of the Member entity.
// If the Member object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MemberMutation) OldOidcSubject(ctx context.Context) (v string, err error) {
...
func (m *MemberMutation) ResetOidcSubject() {
	m.oidc_subject = nil
}
...
func (m *MemberMutation) Fields() []string {
	...
	if m.oidc_subject != nil {
		fields = append(fields, member.FieldOidcSubject)
	}
