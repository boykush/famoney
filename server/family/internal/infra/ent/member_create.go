...
func (_c *MemberCreate) SetOidcSubject(v string) *MemberCreate {
...
func (_c *MemberCreate) check() error {
	if _, ok := _c.mutation.OidcSubject(); !ok {
		return &ValidationError{Name: "oidc_subject", err: errors.New(`ent: missing required field "Member.oidc_subject"`)}
	}
