...
func (_u *MemberUpdate) SetOidcSubject(v string) *MemberUpdate {
	_u.mutation.SetOidcSubject(v)
	return _u
}

// SetNillableOidcSubject sets the "oidc_subject" field if the given value is not nil.
func (_u *MemberUpdate) SetNillableOidcSubject(v *string) *MemberUpdate {
	if v != nil {
		_u.SetOidcSubject(*v)
	}
	return _u
...
func (_u *MemberUpdate) check() error {
	if v, ok := _u.mutation.OidcSubject(); ok {
		if err := member.OidcSubjectValidator(v); err != nil {
			return &ValidationError{Name: "oidc_subject", err: fmt.Errorf(`ent: validator failed for field "Member.oidc_subject": %w`, err)}
		}
	}
...
func (_u *MemberUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.OidcSubject(); ok {
		_spec.SetField(member.FieldOidcSubject, field.TypeString, value)
	}
...
// SetOidcSubject sets the "oidc_subject" field.
func (_u *MemberUpdateOne) SetOidcSubject(v string) *MemberUpdateOne {
	_u.mutation.SetOidcSubject(v)
	return _u
}

// SetNillableOidcSubject sets the "oidc_subject" field if the given value is not nil.
func (_u *MemberUpdateOne) SetNillableOidcSubject(v *string) *MemberUpdateOne {
	if v != nil {
		_u.SetOidcSubject(*v)
	}
	return _u
